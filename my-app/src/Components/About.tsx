  ...
  <div className="flex flex-col-reverse xl:flex-row items-center gap-8 md:gap-16">
    ...
    <div className="flex-1 flex justify-center">
      <Image
        ...
        width={300}
        height={300}
        className="w-50 h-50 md:w-64 md:h-94 lg:w-80 lg:h-90 rounded-full object-cover transition-transform transform hover:scale-110 duration-500 shadow-lg hover:shadow-pink-700"
      />
    </div>
  </div>
</section>
